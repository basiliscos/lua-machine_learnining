...
-- ml_test.classify('t/data/iris.data', id3_instance)

-- subtest(
--    "footbal samples",
--    function()
--       local id3_instance = id3.new()
--       ml_test.classify('t/data/footbal.data', id3_instance)
--       local value = id3_instance:classify({'b','guest','stay','n'}, attributes_count)
--       print("predict: " .. value)
--       ok(value)
--    end
-- )
